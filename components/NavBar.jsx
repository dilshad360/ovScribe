            ...
            <>
              ...
              <Link href="/user/create-post">
                <Button variant="outline">
                  {" "}
                  <SquarePen className="mr-1 w-4" /> Write
                </Button>
              </Link>
              ...
              <div>
                ...
                {showProfilePanel && (
                  <motion.div
                    ...
                    className="w-[280px] bg-white absolute right-0 my-2 mx-10 rounded-xl shadow-lg border-2 flex justify-between items-center px-4 py-2 flex-col z-10"
                  >
